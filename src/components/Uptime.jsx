...
export default function Uptime() {
    ...
    return (
        <span className={'tw-app'}>
            <a href={"https://status.crossrambles.com"} target={"_blank"} className={'absolute top-0 left-0 text-sm max-w-max !bg-black border !border-white/25 rounded-full px-2.5 py-1 my-[0.825rem] break:flex flex-row gap-x-1 items-center !text-white !no-underline hidden'}>
