...
tippy('.bio__social [title]:first-of-type', {
	arrow: false,
	placement: 'top-start',
	offset: [0,3],
	theme: 'wolfhead',
...
tippy('.bio__social [title]:not(:first-of-type):not(:last-of-type)', {
	arrow: false,
	placement: 'top',
	offset: [0,3],
	theme: 'wolfhead',
...
tippy('.bio__social [title]:last-of-type', {
	arrow: false,
	placement: 'top-end',
	offset: [0,3],
	theme: 'wolfhead',
...
tippy('.license__block .bottom [title]', {
	arrow: true,
	placement: 'top',
	offset: [0,3],
	theme: 'wolfhead license',
...
function showLoginForm() {
	...
	document.querySelector('#login__form').innerHTML = '' +
		'<iframe id="login__iframe" src="https://crossrambles.com/wp-login.php?redirect_to=https://crossrambles.com/wp-admin/" onload="injectLoginForm(this);"></iframe>' +
	'';
